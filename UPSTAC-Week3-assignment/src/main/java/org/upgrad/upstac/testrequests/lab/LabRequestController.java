...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User tester = userLoggedInService.getLoggedInUser(); //This creates a User object and gets the current logged in Tester
        return testRequestQueryService.findByTester(tester); //This returns the list of test requests assigned to current logged in Tester
